...
app.run(['$rootScope', '$location', 'AuthService', 'SockService', 'Session', 'SourceQueue', 'Player', 'Event', 'AUTH_EVENTS',
    function ($rootScope, $location, AuthService, SockService, Session, SourceQueue, Player, Event, AUTH_EVENTS) {
